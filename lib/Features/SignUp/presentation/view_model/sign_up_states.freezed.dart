...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignUpStates<T>);
}
...
/// @nodoc
class $SignUpStatesCopyWith<T,$Res>  {
$SignUpStatesCopyWith(SignUpStates<T> _, $Res Function(SignUpStates<T>) __);
}


/// Adds pattern-matching-related methods to [SignUpStates].
extension SignUpStatesPatterns<T> on SignUpStates<T> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial<T> value)?  initial,TResult Function( SignUpLoading<T> value)?  loading,TResult Function( SignUpSuccess<T> value)?  success,TResult Function( SignUpError<T> value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial<T> value)  initial,required TResult Function( SignUpLoading<T> value)  loading,required TResult Function( SignUpSuccess<T> value)  success,required TResult Function( SignUpError<T> value)  error,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial<T> value)?  initial,TResult? Function( SignUpLoading<T> value)?  loading,TResult? Function( SignUpSuccess<T> value)?  success,TResult? Function( SignUpError<T> value)?  error,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case SignUpLoading() when loading != null:
...
class _Initial<T> implements SignUpStates<T> {
  const _Initial();
...
class SignUpLoading<T> implements SignUpStates<T> {
  const SignUpLoading();
...
class SignUpSuccess<T> implements SignUpStates<T> {
...
@override
String toString() {
  return 'SignUpStates<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SignUpSuccessCopyWith<T,$Res> implements $SignUpStatesCopyWith<T, $Res> {
...
class SignUpError<T> implements SignUpStates<T> {
...
@override
String toString() {
  return 'SignUpStates<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $SignUpErrorCopyWith<T,$Res> implements $SignUpStatesCopyWith<T, $Res> {
