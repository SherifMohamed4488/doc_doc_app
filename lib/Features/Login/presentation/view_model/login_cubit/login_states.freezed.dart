...
class _Initial<T> implements LoginStates<T> {
  const _Initial();
...
class Loading<T> implements LoginStates<T> {
  const Loading();
...
class Success<T> implements LoginStates<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $LoginStatesCopyWith<T, $Res> {
...
class Error<T> implements LoginStates<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $LoginStatesCopyWith<T, $Res> {
